...
Админ-панель использует **стиль VS Code / Cursor** - светлую тему с минималистичным дизайном для удобной работы с данными.

### Цветовая схема VS Code

```css
--vscode-bg: #ffffff              /* Основной фон */
--vscode-bg-secondary: #f3f3f3   /* Вторичный фон */
--vscode-sidebar: #f8f8f8         /* Боковая панель */
--vscode-border: #e8e8e8          /* Границы */
--vscode-accent: #007acc          /* Акцентный цвет (синий VS Code) */
--vscode-text: #333333            /* Основной текст */
--vscode-text-secondary: #666666  /* Вторичный текст */
```

### Структура админ-панели

- **Боковая панель** (250px) - фиксированная слева, как в VS Code
- **Верхняя панель** (48px) - заголовок и действия
- **Основной контент** - адаптивная область с отступами

### Компоненты админ-панели

**Статистические карточки (Small Boxes):**
```html
...
- `bg-info` - Голубой (основная информация)
- `bg-success` - Зеленый (успех/рост)
- `bg-warning` - Оранжевый (предупреждение)
- `bg-danger` - Красный (важное)

**Таблицы:**
- Прозрачный фон с glassmorphism
- Четкие границы для разделения строк
- Hover эффекты для лучшей читаемости
...
### Принципы для админ-панели

1. **Читаемость данных** - приоритет удобству работы
2. **Четкие границы** - разделение элементов
3. **Контрастные цвета** - для статусов и важной информации
4. **Интерактивность** - визуальная обратная связь
5. **Единый стиль** - с основным сайтом
...
- [ ] Микро-анимации
- [ ] 3D эффекты
- [ ] Расширенные компоненты для форм
